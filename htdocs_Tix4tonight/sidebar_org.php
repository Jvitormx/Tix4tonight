...
<head>
  <meta charset="UTF-8">
  <link rel="stylesheet" href="css/sidebar_org.css">
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    echo '<a href="editar_org.php?idOrganizador=' . ($row->idOrganizador) . '">';
  }
} else {
  echo "0 results";
}
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    echo '<a href="meus_eventos.php?pag=1&idOrganizador=' . ($row->idOrganizador) . '">';
  }
} else {
  echo "0 results";
}
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    $idOrgan = ($row->idOrganizador);
    $sql2 = "SELECT * FROM evento WHERE Organizador_idOrganizador = '$idOrgan'";
  }
} else {
  echo "0 results";
}
...
if ($result2->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result2))
        {
    echo '<a href="meus_ingressos.php?pag=1&id=' . ($row->id) . '">';
  }
} else {
  echo "0 results";
}
