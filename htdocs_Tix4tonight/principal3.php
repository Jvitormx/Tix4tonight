...
$idcliente0 = $_SESSION['id'];
require 'conexao.php';


$sqlvv = "SELECT * FROM cliente WHERE idCliente = '$idcliente0'";
...
<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/assets/owl.theme.default.css'>
   ...
   <body>
      <nav>
         ...
         <div class="logo">
           <a href="principal3.php"><img src="/imagens/logo4.png" alt="Image" height="25" width="150" ></a>
         ...
         <div class="nav-items">
           ...
           <div class="nav-items">
            <a href="eventoscontrolar.html" target="_blank"><img src="calendar.svg"></a>
...
if($_SESSION['acesso']=="Org"){
    echo "<li><a href='sidebar_org.php' target='_blank'>Perfil | ". $acesso ."</a></li>";
} elseif ($_SESSION['acesso']=="Comum") {
	echo "<li><a href='sidebar_cliente.php' target='_blank'>Perfil | ". $acesso ."</a></li>";
} else {
    echo "<li><a href='sidebar_adm.php' target='_blank'>Perfil | ". $acesso ."</a></li>";
}
...
//Menu só aparece para os administradores.
if($_SESSION['acesso']=="Org"){
    echo "<a class='cta' href='tela_criar_evento.php' target='_blank'>Criar evento ⇪</a>";
} else {
	echo "<a class='cta' href='cadastro_Organizador.html' target='_blank'>Seja Organizador</a>";
}
?>
      </nav>
<body>
...
<section class="game-section">
  ...
  <div class="owl-carousel custom-carousel owl-theme">
	...
	<?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM evento where status='1' ORDER BY id DESC");
...
<?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM evento WHERE Categoria_idCategoria = '5' and status='1' ORDER BY id DESC");
 ...
 echo '<img src="data:image/jpeg;base64,'.base64_encode($row->img) .'" />';
  ...
  echo '<div class="card-text">';
    ...
    echo '<p class="version-one">' . ($row->infLocal) . ' - ' . ($row->bairro) . '<p>';
  echo '</div>';
echo '</div>';
...
<div class="card-content">
    ...
    <?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM evento WHERE Categoria_idCategoria = '6' and status='1' ORDER BY id DESC");
...
<button id="next" class="btn">
	...
	<h2 class=versionzero><strong>Eventos próximos a você <span></span></strong></h2>
...
<div class="card-content">
    ...
    <?php
	$localizacaophp = $rowvv["localizacao"];
        $result = mysqli_query($conn, "SELECT * FROM evento WHERE bairro= '$localizacaophp' and status='1' ORDER BY id DESC");
...
<div class="card-content">
    ...
    <?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM evento WHERE Categoria_idCategoria = '7' and status='1' ORDER BY id DESC");
...
<div class="card-content">
    ...
    <?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM evento WHERE Categoria_idCategoria = '10' and status='1' ORDER BY id DESC");
...
<div class="card-content">
    ...
    <?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM evento WHERE Categoria_idCategoria = '8' and status='1' ORDER BY id DESC");
...
<div class="card-content">
    ...
    <?php
        ...
        $result = mysqli_query($conn, "SELECT * FROM evento WHERE Categoria_idCategoria = '9' and status='1' ORDER BY id DESC");
...
<body>
 ...
 <h4>Links úteis</h4>
                    <ul>
                        ...
                        <li><a href="#" class="text">Termos e condições</a></li>
                    </ul>
