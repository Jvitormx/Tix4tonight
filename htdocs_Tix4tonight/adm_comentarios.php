...
$sql = "SELECT comentario.nome, comentario.comentario, comentario.idComentario, comentario.Evento_idEvento, comentario.comentario_data, evento.title FROM comentario INNER JOIN evento ON comentario.Evento_idEvento = evento.id ORDER BY idComentario LIMIT $id, $total";
