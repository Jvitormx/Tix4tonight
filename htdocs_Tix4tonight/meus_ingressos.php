...
$sql = "SELECT * FROM ingresso WHERE Evento_idEvento = '$idOrg' LIMIT $id, $total";
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>
			...
			<h1>*Ingressos</h1>
			<table>
<tr><th>ID_Ingresso</th><th>Preço</th><th>Quantidade</th><th>Data Limite</th><th>ID_Evento</th></tr>
	...
	<?php
	  while($row = $result->fetch_assoc()) {
		...
		echo "<td>" . $row["idIngresso"] . "</td><td>" . $row["preco"] . "</td><td>" . $row["quantidadeTotal"] . "</td><td>" . $row["dataLimite"] . "</td><td>" . $row["Evento_idEvento"] . "</td>";
 ...
 <?php for($i=1; $i <= $contagem; $i++) {
   echo "<li class='page-item'><a class='page-link' href='meus_ingressos.php?pag=$i&Evento_idEvento=$idOrg'>$i</a></li>";
 } 
?> 
    <li class="page-item">
