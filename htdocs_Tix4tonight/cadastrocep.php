...
<body class="form">
	...
	<div class="page-content">
		<div class="form-v4-content">
			<div class="form-left">
			<form class="form-detail" id="formulario" enctype="multipart/form-data" method="POST" action="processacep.php">
               ...
               onblur="pesquisacep(this.value);" autofocus placeholder="CEP" required>	
				...
				<div class="form-row">
					<label for="your_email">Cidade</label>
						<input type="text" name="cidade" id="cidade" placeholder="Cidade">
				</div>
				<div class="form-row-last">
					<input type="submit" name="registro" class="register" value="Começar">
				</div>
			 </form>
		</div>
	</div>
