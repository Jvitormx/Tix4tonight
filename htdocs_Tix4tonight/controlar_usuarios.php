	...
	<?php
	  while($row = $result->fetch_assoc()) {
		...
		#<td><a href='eventobloquear.php?id=" . $row["id"] . "&status=" . $row["status"] . "'><img src='./imagens/bloquear.png' alt='Bloquear Evento'></a></td><td><a href='usuarioexcluir.php?id=" . $row["Id"] . "'><img src='./imagens/excluir.png' alt='Excluir Usuário'></a></td></tr>";
		 echo "<td><a href='usuariobloquear.php?idCliente=" . $row["idCliente"] . "&status=" . $row["status"] . "'><img src='./imagens/cross1.png' alt='Bloquear usuario'></a></td>";
	  }
	?>
...
<div class="pagination">
 ...
 <?php for($i=1; $i <= $contagem; $i++) {
   echo "<li class='page-item'><a class='page-link' href='controlar_usuarios.php?pag=$i'>$i</a></li>";
 } 
?> 
    <li class="page-item">
