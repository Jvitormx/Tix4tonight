...
<body class="form">
	...
	<div class="page-content">
		<div class="form-v4-content">
			<div class="form-left">
			<form class="form-detail" enctype="multipart/form-data" method="POST" action="processarloc.php">
               ...
               onblur="pesquisacep(this.value);" autofocus placeholder="CEP" required><br />
            ...
            <div> 
					...
					<div class="form-row-last">
						<input type="submit" name="register" id="register" class="register" value="Confirmar">
