...
$sql = "SELECT * FROM cliente WHERE nome = '$logado'";
...
<head>
  ...
  <link rel="stylesheet" href="css/sidebar_cliente.css">
...
<header class="page-header">
  <nav>
    <a href="principal3.php" aria-label="forecastr logo" class="logo">
    ...
    <ul class="admin-menu">
	  ...
	  while ($row = mysqli_fetch_object($result))
        {
    echo '<h3>'. ($row->nome) . '-' . ($row->acesso) . '</h3>';
  }
} else {
  echo "0 results";
}
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    echo '<a href="editar_cliente.php?idCliente=' . ($row->idCliente) . '">';
  }
} else {
  echo "0 results";
}
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    echo '<a href="controlar_usuarios.php?pag=1">';
  }
} else {
  echo "0 results";
}
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    echo '<a href="adm_comentarios.php?pag=1">';
  }
} else {
  echo "0 results";
}
?>
          ...
          <span>Administrar comentarios</span>
        </a>
      </li>
      <li>
        <?php
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    echo '<a href="controlar_org.php?pag=1">';
  }
} else {
  echo "0 results";
}
?>
          ...
          <span>Administrar Organizadores</span>
        </a>
      </li>
      <li>
        <?php
...
if ($result->num_rows > 0) {
 ...
 while ($row = mysqli_fetch_object($result))
        {
    echo '<a href="controlar_eventos.php?pag=1">';
  }
} else {
  echo "0 results";
}
