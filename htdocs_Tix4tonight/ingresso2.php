...
$sql = "INSERT INTO ingresso (TipodeIngresso_idTipodeIngresso, preco, quantidadeTotal, dataLimite, statusIng, Evento_idEvento, selecao, promocao) VALUES ('$campotipo', '$campopreco', '$campoquant', '$campolit', '1', (SELECT id from evento WHERE title='$titulo'), 'aguardando', 'null')";
