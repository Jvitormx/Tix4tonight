...
<header class="page-header">
  <nav>
    ...
    <h3> Usuário: <%=request.getSession().getAttribute("cliente")%> </h3>
  ...
  <h3> </h3>
   ...
   <a href="escreveremailorg.jsp">
 
          <svg>
            <use xlink:href="#comments"></use>
          </svg>
          <span>Emails promocionais-org</span>
        </a>
      </li>
      <li>
        <a href="#0">
